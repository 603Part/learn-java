...
public class StudentCourseDaoImpl implements StudentCourseDao {
	...
	public List<StudentCourse> findAll(int studentID) {
		...
		try {
			List<StudentCourse> sCourses = runner.query(sql, new BeanListHandler<StudentCourse>(StudentCourse.class),
					params);
			return sCourses;
	...
	public StudentCourse find(int courseID, int studentID) {
		...
		try {
			StudentCourse sc = runner.query(sql, new BeanHandler<StudentCourse>(StudentCourse.class), params);
			return sc;
		} catch (SQLException e) {
			e.printStackTrace();
		}

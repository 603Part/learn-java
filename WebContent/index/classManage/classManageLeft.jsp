...
<body style="background-image: url(${pageContext.request.contextPath}/index/tleft.jpg)">
	...
	<ul style="list-style-type: none">
		<li><a
			href="${pageContext.request.contextPath }/WebCourseServlet?action=goShowPage"
			target="${requestScope.target}">开授新课</a></li>
 		<li><a
			href="${pageContext.request.contextPath }/WebCourseServlet?action=findMyCourse" 
			target="${requestScope.target}">我的课程</a></li> 
	</ul>
</body>
</html>
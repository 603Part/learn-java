...
<body style="background-image: url(${pageContext.request.contextPath}/index/tleft.jpg)">
	...
	<ul style="list-style-type: none">
		<li><a
			href="${pageContext.request.contextPath }/WebBbsServlet?action=findQuestion"
			target="${requestScope.target}">查看问题</a></li>
		<li><a
			href="${pageContext.request.contextPath }/WebBbsServlet?action=showReplyList"
			target="${requestScope.target}">我的回答</a></li>
	</ul>
</body>
</html>

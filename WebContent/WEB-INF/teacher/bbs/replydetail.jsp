...
<body
	...
	<form
		action="${pageContext.request.contextPath}/WebBbsServlet?action=modReply"
		method="post">
<!--  		<table>
			<tr>
				<td>问题标题：</td>
			...
			<tr>
				<td><input type="hidden" name="replyID"
					value="${replyPost.replyID}"></td>
				<td></td>
		...
		<table>
			<tr>
				<td>问题标题：</td>
				<td><input type="text" 
					value="${bbsTheme.postTitle}" /></td>
			</tr>
			<tr>
				<td>问题内容：</td>
				<td><input type="text" width="500px"
					value="${bbsTheme.postContent}" /></td>
			</tr>
			<tr>
				<td>提问时间：</td>
				<td><input type="text" 
					value="${bbsTheme.postTime}" /></td>
			</tr>
			<tr>
				<td>我的回答：</td>
				<td><textarea rows="10" cols="60" name="reply">${replyPost.replyContent}</textarea></td>
			</tr>
	...
	<!--  		<tr>
			...
			<tr>
				<td></td>
				<td><font color="red">${replyPost.replyID}</font></td>
			</tr>
		-->
		</table>

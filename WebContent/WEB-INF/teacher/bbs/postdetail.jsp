...
<body
	...
	<form
		action="${pageContext.request.contextPath}/WebBbsServlet?action=sendReply"
		method="post">
		<table>
			<tr>
				<td>问题内容：</td>
			...
			<tr>
				<td><input type="hidden" name="postID"
					value="${bbsTheme.postID}"></td>
			</tr>
			<tr>
				<td>提问者：</td>
				<td>${bbsTheme.studentNumber}</td>
			...
			<tr>
				...
				<td><input type="submit" value="提交"
					style="margin-left: 460px; width: 120px" /></td>
			</tr>

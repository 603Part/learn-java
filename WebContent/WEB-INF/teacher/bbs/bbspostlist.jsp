		...
		<tbody>
			<c:forEach items="${bbsThemes}" var="bbs">
				<tr>
					...
					<td data-lable="操作">
						<a href="${pageContext.request.contextPath }/WebBbsServlet?action=findPostDetail&postID=${bbs.postID}&courseID=${bbs.courseID}">回复</a>
						&nbsp&nbsp
						<a href="${pageContext.request.contextPath }/WebBbsServlet?action=delPost&postID=${bbs.postID}&courseID=${bbs.courseID}">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>

...
<body
	...
	<form
		action="${pageContext.request.contextPath}/WebInfoServlet?action=updateInfo"
		...
		<table>
			...
			<tr>
				<td>输入密码：</td>
				<td><input placeholder="请输入密码，不输入默认不更改" type="password" name="userPass1" style='width: 213px'
				onblur="if(userPass2.value!=''&&userPass2.value!=null&&userPass1.value!=userPass2.value) alert('两次密码一致！');"/></td>
			</tr>
			<tr>
				<td>确认密码：</td>
				<td><input placeholder="再次输入密码，不输入默认不更改" type="password" name="userPass2" style='width: 213px'
			...
			<tr>
				<td colspan="3" align="center"><input type="submit" value="重新提交" />
					<input type="reset" /></td>
			</tr>
			<tr>
				<td></td>

...
<body
	...
	<form
		...
		<table>
			<tr>
				<td>课程名称：</td>
				<td><input type="text" name="courseName" value="${requestScope.courseName}" required/></td>
			</tr>
			<tr>
				<td>课程简介：</td>
				<td><input type="text" name="courseAbstract" value="${requestScope.courseAbstract}" required/></td>
			</tr>
			<tr>
				<td>详细信息：</td>
			...
			<tr>
				<td>选择封面：</td>
				<td><input type="file" name="uphoto" accept="image/jpg, image/jpeg, image/gif, image/png" required/></td>
			</tr>
